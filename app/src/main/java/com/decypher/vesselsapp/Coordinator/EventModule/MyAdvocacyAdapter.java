...
/**
 * Created by trebd on 11/11/2017.
 */

public class MyAdvocacyAdapter extends RecyclerView.Adapter<MyAdvocacyAdapter.ViewHolder> {
    ...
    public MyAdvocacyAdapter(Context context, ArrayList<BloodDriveData> driveList) {
    ...
    @Override
    public MyAdvocacyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_blooddrive_item, parent, false);
        return new MyAdvocacyAdapter.ViewHolder(view);
    }

    public void onBindViewHolder(MyAdvocacyAdapter.ViewHolder holder, int position) {
        ...
        public ViewHolder(final View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, MySelectedAdvocacyActivity.class);
