...
public class ViewAdvocacyAttendee extends AppCompatActivity {

    RecyclerView recyclerview;
    ArrayList<SearchData> donorList;
    SearchEventAdapterCoordinator adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new SearchEventAdapterCoordinator(ViewAdvocacyAttendee.this, donorList);
        ...
        drive_id = extras.getString("EVENT_ID");
        ...
        drivesReference = mDatabase.getReference(EVENTS_REFERENCE);
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    if(dataSnapshot1.getValue().equals(true)){
                        count++;
                        txtCount.setText("Attendees: "+String.valueOf(count));
                    }
                }
            }
