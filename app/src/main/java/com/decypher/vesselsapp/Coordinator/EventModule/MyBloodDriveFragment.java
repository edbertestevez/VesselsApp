 ...
 */
public class MyBloodDriveFragment extends Fragment {

    ArrayList<BloodDriveData> driveList;
    View view;
    ProgressDialog progressDialog;
    RecyclerView recyclerView;
    MyBloodDriveAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_my_blood_drive, container, false);
        ...
        adapter = new MyBloodDriveAdapter(getActivity().getApplicationContext(), driveList);
    ...
    private void displayMyDrives() {
        driveList.clear();
        driveReference.addChildEventListener(new ChildEventListener() {
            @Override
