...
public class AddBloodDriveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_blood_drive);

        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setTitle("New Blood Drive");

        progDialog = new ProgressDialog(AddBloodDriveActivity.this);
        ...
        etDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(AddBloodDriveActivity.this, date, myCalendar
        ...
        etTimeStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mTimePicker = new TimePickerDialog(AddBloodDriveActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
            ...
            public void onClick(View view) {
                if (globalFunctions.isNetworkAvailable()) {
                    ...
                    if(name.isEmpty() || address.isEmpty() || description.isEmpty() || event_date.isEmpty() || timeStart.isEmpty() || timeEnd.isEmpty()||imgUri==null){
                        Toast.makeText(AddBloodDriveActivity.this, "Please complete all fields", Toast.LENGTH_SHORT).show();
                    }else{
                        ...
                        builder.setMessage("Save Post?")
                                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        ...
                                        progDialog.show();
                        //new id
                        key = driveReference.child(sharedpref.getString("COR_ID", "")).push().getKey();
                        ...
                        ref.putFile(imgUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            public void onSuccess(final UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                driveReference.child(sharedpref.getString("COR_ID", "")).child(key).child("photo").setValue(taskSnapshot.getDownloadUrl().toString(), new DatabaseReference.CompletionListener() {
                                    @Override
                                    public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                        ...
                                        driveReference.child(sharedpref.getString("COR_ID","")).child(key).setValue(newPost, new DatabaseReference.CompletionListener() {
                                            @Override
                                            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                                progDialog.dismiss();
                                                finish();
                                                Toast.makeText(AddBloodDriveActivity.this, "Post successfully added", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(AddBloodDriveActivity.this, "An Error Occured", Toast.LENGTH_SHORT).show();
                                    }
                                })
                    ...
                    Toast.makeText(AddBloodDriveActivity.this, "There is no internet connection", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
