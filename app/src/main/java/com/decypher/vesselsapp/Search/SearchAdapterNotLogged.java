...
public class SearchAdapterNotLogged  extends RecyclerView.Adapter<SearchAdapterNotLogged.ViewHolder> {
    ...
    public SearchAdapterNotLogged(Context context, ArrayList<SearchData> searchList) {
    ...
    @Override
    public SearchAdapterNotLogged.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.donor_list_item, parent, false);
        return new SearchAdapterNotLogged.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(SearchAdapterNotLogged.ViewHolder holder, int position) {
